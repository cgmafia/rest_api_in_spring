package com.sacsolutions.expensetrackerapi.resources;

import com.sacsolutions.expensetrackerapi.domain.Transaction;
import com.sacsolutions.expensetrackerapi.services.TransactionService;
...
public class TransactionResource {
    ...
    @GetMapping("")
    public ResponseEntity<Transaction> getAllTransactions(HttpServletRequest request, @PathVariable("categoryId") Integer categoryId, @PathVariable("transactionId") Integer transactionId){
    ...
    @PostMapping("")
    public ResponseEntity<Transaction> addTransaction(HttpServletRequest request, @PathVariable("categoryId") Integer categoryId, @RequestBody
